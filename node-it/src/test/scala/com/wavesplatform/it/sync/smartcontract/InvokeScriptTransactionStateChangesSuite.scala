...
class InvokeScriptTransactionStateChangesSuite extends BaseTransactionSuite with CancelAfterFailure {
  ...
  private val contract  = firstKeyPair
  private val caller    = secondKeyPair
  private val recipient = thirdKeyPair
  ...
  private val recipientAddress: String = recipient.toAddress.toString
  private val callerAddress: String    = caller.toAddress.toString
