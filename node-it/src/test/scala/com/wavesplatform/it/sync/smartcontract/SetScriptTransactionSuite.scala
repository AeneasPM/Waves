...
class SetScriptTransactionSuite extends BaseTransactionSuite with CancelAfterFailure {
  private val fourthAddress: KeyPair = sender.createKeyPair()
  private val fifthAddress: KeyPair  = sender.createKeyPair()

  private val acc0 = firstKeyPair
  private val acc1 = secondKeyPair
  private val acc2 = thirdKeyPair
  private val acc3 = fourthAddress
  private val acc4 = fifthAddress
