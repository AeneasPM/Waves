...
class InvokeScriptTransactionSuite extends BaseTransactionSuite with CancelAfterFailure {
  ...
  private val firstContract  = firstKeyPair
  private val secondContract = secondKeyPair
  private val thirdContract  = sender.createKeyPair()
  private val caller         = thirdKeyPair

  private val firstContractAddress: String  = firstContract.toAddress.toString
  private val secondContractAddress: String = secondContract.toAddress.toString
