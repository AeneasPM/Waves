...
class InvokeSelfPaymentSuite extends BaseTransactionSuite with CancelAfterFailure {
  ...
  private val caller = firstKeyPair
  private val dAppV4 = secondKeyPair
  private val dAppV3 = thirdKeyPair

  private var asset1: IssuedAsset = _
  private def asset1Id            = asset1.id.toString

  private val dAppV3Address: String = dAppV3.toAddress.toString
  private val dAppV4Address: String = dAppV4.toAddress.toString
