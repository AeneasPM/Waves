...
class DebugPortfoliosSuite extends FunSuite with NodesFromDocker {
  ...
  private val firstAcc  = sender.createKeyPair()
  private val secondAcc = sender.createKeyPair()

  private val firstAddress: String  = firstAcc.toAddress.toString
  private val secondAddress: String = secondAcc.toAddress.toString
